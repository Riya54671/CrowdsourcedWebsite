export default function Profile() {
  return (
    <div className="flex min-h-screen bg-[#1A1A38] text-white">
    {/* Sidebar - Fixed width */}
    <div className="w-20 flex-shrink-0 flex flex-col items-center py-6 space-y-8 bg-[#1A1A38] border-r border-white/10 font-roboto">
  ...
  <svg width="60" height="60" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      ...
      <main className="flex-1 px-12 py-10 text-lg space-y-10">
        {/* Edit Button */}
        <button className="px-6 py-2 bg-white text-black rounded-full font-semibold text-base">
        👤 View your profile
        </button>

        {/* Profile Card */}
        <div className="bg-[#1A1A38] relative rounded-xl border border-white/20 p-8 flex items-center space-x-8">

        <div className="absolute top-6 right-6">
        <svg width="40" height="43" viewBox="0 0 58 52" fill="none" xmlns="http://www.w3.org/2000/svg">
<g opacity="0.8">
<path d="M40.5094 35.029L43.7316 31.779C44.2351 31.2711 45.1111 31.6266 45.1111 32.3579V47.1251C45.1111 49.8165 42.9462 52.0001 40.2778 52.0001H4.83333C2.16493 52.0001 0 49.8165 0 47.1251V11.375C0 8.68364 2.16493 6.50005 4.83333 6.50005H32.3733C33.0882 6.50005 33.4507 7.37349 32.9472 7.89146L29.725 11.1415C29.574 11.2938 29.3726 11.375 29.151 11.375H4.83333V47.1251H40.2778V35.5977C40.2778 35.3844 40.3583 35.1813 40.5094 35.029ZM56.2781 14.5336L29.8358 41.204L20.733 42.2196C18.0948 42.5141 15.8493 40.2696 16.1413 37.5883L17.1483 28.4071L43.5906 1.73677C45.8965 -0.589014 49.6222 -0.589014 51.9181 1.73677L56.2681 6.12427C58.574 8.45005 58.574 12.218 56.2781 14.5336ZM46.3295 17.6719L40.4792 11.7711L21.7701 30.6516L21.0351 37.2836L27.6104 36.5422L46.3295 17.6719ZM52.8545 9.57739L48.5045 5.18989C48.0917 4.77349 47.417 4.77349 47.0142 5.18989L43.9028 8.32817L49.7531 14.229L52.8646 11.0907C53.2674 10.6641 53.2674 9.9938 52.8545 9.57739Z" fill="white"/>
</g>
</svg>
          ...
          {/* Info */}
          <div>
            <p className="text-sm text-white/60 font-roboto">snehaiyer</p>
            <p className="text-4xl font-bold font-roboto">Sneha Iyer</p>
            <p className="text-lg text-white/70 font-roboto">senhaiyer@gmail.com</p>
            <p className="text-sm text-white/50 mt-1 font-roboto">Doctor</p>
          </div>
        </div>
...
<svg width="30" height="32" viewBox="0 0 58 52" fill="none" xmlns="http://www.w3.org/2000/svg">
<g opacity="0.8">
<path d="M40.5094 35.029L43.7316 31.779C44.2351 31.2711 45.1111 31.6266 45.1111 32.3579V47.1251C45.1111 49.8165 42.9462 52.0001 40.2778 52.0001H4.83333C2.16493 52.0001 0 49.8165 0 47.1251V11.375C0 8.68364 2.16493 6.50005 4.83333 6.50005H32.3733C33.0882 6.50005 33.4507 7.37349 32.9472 7.89146L29.725 11.1415C29.574 11.2938 29.3726 11.375 29.151 11.375H4.83333V47.1251H40.2778V35.5977C40.2778 35.3844 40.3583 35.1813 40.5094 35.029ZM56.2781 14.5336L29.8358 41.204L20.733 42.2196C18.0948 42.5141 15.8493 40.2696 16.1413 37.5883L17.1483 28.4071L43.5906 1.73677C45.8965 -0.589014 49.6222 -0.589014 51.9181 1.73677L56.2681 6.12427C58.574 8.45005 58.574 12.218 56.2781 14.5336ZM46.3295 17.6719L40.4792 11.7711L21.7701 30.6516L21.0351 37.2836L27.6104 36.5422L46.3295 17.6719ZM52.8545 9.57739L48.5045 5.18989C48.0917 4.77349 47.417 4.77349 47.0142 5.18989L43.9028 8.32817L49.7531 14.229L52.8646 11.0907C53.2674 10.6641 53.2674 9.9938 52.8545 9.57739Z" fill="white"/>
</g>
</svg>
...
{/* Section Content */}
<h2 className="font-bold text-2xl font-roboto">Pinned Work</h2>

<p className="text-base text-white/70 max-w-2xl mb-1 font-roboto">
  You can now add Pinned Work to your profile! Pin any item that you own like a Notebook or Dataset. Or you can pin images and give relevant feedback.
        ...
        {/* Bio */}
        <section className="border-t border-white/10 pt-6 relative">
