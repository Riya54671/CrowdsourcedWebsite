...
<div className="flex-1 p-10 bg-[#1A1A38] text-white">
  <h1 className="text-4xl font-bold mb-8 font-roboto">Post a New Thread</h1>

  <div className="mb-6">
    <label className="block mb-2 text-xl font-medium font-roboto">Topic</label>
    <input
      type="text"
      className="w-full p-3 bg-[#1A1A38] text-white font-roboto rounded-md resize-none border border-white focus:outline-none focus:ring-2 focus:ring-[#FFB74D]"
      value={threadData.threadName}
      onChange={(e) => setThreadData({ ...threadData, threadName: e.target.value })}
      placeholder="Enter topic"
    />
  </div>

  <div className="mb-6">
    <label className="block mb-2 text-xl font-roboto">Short Description</label>
    <textarea
      className="w-full p-3 bg-[#1A1A38] text-white rounded-md resize-y min-h-[60px] border border-white focus:outline-none focus:ring-2 focus:ring-[#FFB74D]"
  ...
  <div className="mb-6">
    <label className="block mb-2 text-xl font-roboto">Content</label>
    <textarea
      className="w-full p-3 bg-[#1A1A38] text-white font-roboto rounded-md resize-y min-h-[120px] border border-white focus:outline-none focus:ring-2 focus:ring-[#FFB74D]"
 ...
 onClick={() => {
  ...
  className="w-[900px] font-roboto py-3 bg-white text-black font-bold rounded-full hover:bg-gray-100 transition ml-[170px]"
>
  Post Thread
</button>
