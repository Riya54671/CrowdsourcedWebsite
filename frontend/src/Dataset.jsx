...
const[datasets, setDatasets] = useState(" ");
    ...
    return(
        <div className="relative bg-[#1A1A38]  min-h-screen w-full flex justify-start items-start  overflow-y-scroll">
        ...
        <div className="flex flex-col justify-start justify-items-start space-y-8 pt-5 pr-20 pl-0">
            { /*hambuger Three lines */}
        <svg className="pt-2 cursor-pointer hover:bg-white/10 "  xmlns="http://www.w3.org/2000/svg" width="48" height="29" viewBox="0 0 48 29" fill="none">
...
{/* circle */}
<svg classname="absolute z-0 top-10 left-5 cursor-pointer hover:bg-white/10 "   xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 80 80" fill="none">
...
<svg className="cursor-pointer hover:bg-white/10 " xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 76 76" fill="none">
...
{/* dataset */}
<button >
<svg className="cursor-pointer hover:bg-white/10 " xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 88 88" fill="none">
...
<svg className="cursor-pointer hover:bg-white/10 " xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 78 78" fill="none">
...
<h3 className="absolute top-20 z-50 left-8 font-roboto text-[64px] font-semibold text-white tracking-normal">
  Datasets
</h3>
</div>
<h6 className="absolute top-40  left-60 font-roboto text-[28px] font-normal text-[#D9D9D9] tracking-normal">Explore, analyze and share quality data</h6>

<button onClick={()=>navigate("/DatasetDetails")} className=" absolute top-55 left-60 flex flex-row justify-center items-center bg-white w-[300px] h-[70px] rounded-[20px] gap-2 " >
<svg className=" fill-[#1A1A38]  w-10 h-10 mt-1" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
  <path d="M37.9998 16.6667H27.3332V5.99999C27.3332 4.5855 26.7713 3.22895 25.7711 2.22875C24.7709 1.22856 23.4143 0.666656 21.9998 0.666656C20.5854 0.666656 19.2288 1.22856 18.2286 2.22875C17.2284 3.22895 16.6665 4.5855 16.6665 5.99999L16.8558 16.6667H5.99984C4.58535 16.6667 3.22879 17.2286 2.2286 18.2288C1.22841 19.2289 0.666504 20.5855 0.666504 22C0.666504 23.4145 1.22841 24.771 2.2286 25.7712C3.22879 26.7714 4.58535 27.3333 5.99984 27.3333L16.8558 27.144L16.6665 38C16.6665 39.4145 17.2284 40.771 18.2286 41.7712C19.2288 42.7714 20.5854 43.3333 21.9998 43.3333C23.4143 43.3333 24.7709 42.7714 25.7711 41.7712C26.7713 40.771 27.3332 39.4145 27.3332 38V27.144L37.9998 27.3333C39.4143 27.3333 40.7709 26.7714 41.7711 25.7712C42.7713 24.771 43.3332 23.4145 43.3332 22C43.3332 20.5855 42.7713 19.2289 41.7711 18.2288C40.7709 17.2286 39.4143 16.6667 37.9998 16.6667Z" fill="#1A1A38"/>
</svg>
<div className=" font-roboto text-[36px] font-bold text-[#1A1A38] tracking-normal ">New Dataset</div>
</button>

<div onClick={datasets}  className="flex flex-col pl-2 gap-10 pt-80 ml-10 ">
<div className="flex flex-row gap-5 overflow-x-auto w-[1200px] ">
  {[...Array(5)].map((_, i) => (
    <DatasetComp key={i} />
  ))}
</div>
